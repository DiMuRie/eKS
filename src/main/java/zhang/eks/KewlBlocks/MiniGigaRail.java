...
public class MiniGigaRail extends Block{

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final AxisAlignedBB AABB_NORTH = new AxisAlignedBB(0D, 0.0625*1D, 0D, 1D, 0.0625*6D, 1D);
	public static final AxisAlignedBB AABB_EAST = new AxisAlignedBB(0D, 0.0625*1D, 0D, 1D, 0.0625*6D, 1D);
	public static final AxisAlignedBB AABB_SOUTH = new AxisAlignedBB(0D, 0.0625*1D, 0D, 1D, 0.0625*6D, 1D);
	public static final AxisAlignedBB AABB_WEST = new AxisAlignedBB(0D, 0.0625*1D, 0D, 1D, 0.0625*6D, 1D);
	public static final AxisAlignedBB PLAYER_DETECTION = new AxisAlignedBB(0D, 0D, 0D, 1D, 0.6D, 1D);
	
	public MiniGigaRail(){
		super(Material.IRON);
        this.setCreativeTab(EKSItemLoader.tabEKS);
        this.setUnlocalizedName("minigigarail");
        this.setRegistryName("minigigarail");
